...
public class CAlphabet {
	...
	/**
	 * The symbol number of the new-paragraph DasherChar.
	 */
	protected int m_ParagraphSymbol;
	
	/**
	 * The symbol number of the space DasherChar.
	 */
	 ...
	 */
	protected ArrayList<String> m_Foreground;   // stores the colour of the DasherChar foreground
	 ...
	 * (such as the start conversion DasherChar) only if AlphabetInfo
	...
	public CAlphabet(CAlphIO.AlphInfo AlphabetInfo) { 
		...
		for(CAlphIO.DasherChar temp : AlphabetInfo.m_vCharacters) {
			AddChar(temp.Text, temp.Display, temp.Colour, temp.Foreground);
		}
			
		// Set Space DasherChar if requested
	 ...
	 * symbol identifiers. Each DasherChar is individually
	 * used as a key into TextMap to determine its symbol number;
	 * as such their is no support for multi-DasherChar symbols
	 * at present. 
	 * 
	 ...
	 * 			 	 input DasherChar may be an incomplete UTF-8
	 * 				 DasherChar, but redundant since UTF-16 is now
	 * 				 used internally.
	 */
	...
	/**
	 * Adds a new DasherChar to this alphabet. The new DasherChar will
	 * be assigned the next free symbol index.
	 * 
	 * @param NewCharacter Representation of this DasherChar as to be shown in textual output.
	 * @param Display Representation to be shown on screen.
	 * @param Colour Background colour index to be used in drawing nodes containing this DasherChar.
	 ...
	 * status and will become ordinary symbols.
	 * 
	 * @param NewCharacter Redundant; the Control DasherChar is not typed.
	 ...
	 * status and will become ordinary symbols.
	 * 
	 * @param NewCharacter Redundant; the conversion symbol is not a typed DasherChar in the ordinary sense.
	 * @param Display Representation to be shown on screen.
	 * @param Colour Background colour index to be used in drawing nodes containing this DasherChar.
	 * @param Foreground Foreground colour to be used drawing the text..
	 */	
	...
	/**
	 * Retrieves the String which should be displayed to represent a given DasherChar.
	 * 
	 * @param i Index of the DasherChar to be looked up.
	 * @return Display string for this DasherChar.
	 */
	...
	/**
	 * Retrieves the typed DasherChar representation of a given symbol.
	 * 
