 ...
 * be notified.
 * <li>The ability to getSetting and setSetting global settings, using some child of CSettingsStore.
 * </ul>
 * <p>
...
public class CDasherComponent {
	 ...
	 * @param SettingsStore Settings store to be used to getSetting and setSetting parameters. Must not be null.
	 */
	...
	public void HandleEvent(CEvent pEvent) {}
        ...
        public <T> T getSetting(EParameters<T> key) {
            return m_SettingsStore.getSetting(key);
        }

        public <T> void setSetting(EParameters<T> key, T value) {
            m_SettingsStore.setSetting(key, value);
        }
