 ...
 * of a new frame.
 *
 * @deprecated JDasherPanel handles this itself
 */
public class DoFrameTask extends java.util.TimerTask {
	...
	/**
	 * Creates a new task to redraw a specified component.
	 * 
	 * @param newComp Applet to redraw
	 */
	public DoFrameTask(Component newComp) {
		component = newComp;
	}
