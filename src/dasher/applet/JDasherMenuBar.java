...
public class JDasherMenuBar extends JMenuBar implements ActionListener, ItemListener, java.awt.datatransfer.FlavorListener {
	...
	private JMenuItem file_new, file_save, file_saveas, file_open, file_train, file_exit;
	
	private JMenuItem edit_cut, edit_copy, edit_paste, edit_selectall, edit_copyall, edit_preferences;
	...
	public JDasherMenuBar(JDasherMenuBarListener listener) {
		...
		file_new = new JMenuItem("New"); file.add(file_new); file_new.addActionListener(this);
                file_save = new JMenuItem("Save"); file.add(file_save); file_save.addActionListener(this);
                file_saveas = new JMenuItem("Save As..."); file.add(file_saveas); file_saveas.addActionListener(this);
                file_open = new JMenuItem("Open..."); file.add(file_open); file_open.addActionListener(this);
                file_train = new JMenuItem("Train..."); file.add(file_train); file_train.addActionListener(this);
		...
		edit_paste = new JMenuItem("Paste"); edit.add(edit_paste); edit_paste.addActionListener(this);
                ...
                edit_copyall = new JMenuItem("Copy All");
                edit.add(edit_copyall);
                edit_copyall.addActionListener(this);
                edit_preferences = new JMenuItem("Preferences...");
                edit.add(edit_preferences);
                edit_preferences.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("New")) {
			...
			m_Host.menuSelectAll();
		}
                else if(e.getActionCommand().equals("Copy All")) {
			m_Host.menuCopyAll();
		}
                else if(e.getActionCommand().equals("Preferences...")) {
			m_Host.menuPreferences();
		}
