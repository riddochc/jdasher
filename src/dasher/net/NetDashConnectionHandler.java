...
public class NetDashConnectionHandler implements DasherEditListener {
	 ...
	 */	
	public NetDashConnectionHandler(int sessID, int width, int height, String dataLocation, dasher.core.CAlphIO alphIO, dasher.core.CColourIO colIO) {
		...
		Dasher.SetStringParameter(dasher.settings.Esp_parameters.SP_INPUT_FILTER, "Click Mode");
		Dasher.SetStringParameter(dasher.settings.Esp_parameters.SP_INPUT_DEVICE, "Network Input");
		Dasher.SetBoolParameter(dasher.settings.Ebp_parameters.BP_DRAW_MOUSE_LINE, false);
		Dasher.SetBoolParameter(dasher.settings.Ebp_parameters.BP_DRAW_MOUSE, false);
		Dasher.SetLongParameter(dasher.settings.Elp_parameters.LP_ZOOMSTEPS, 1);
		
		Screen.setInitialAlph(Dasher.getSetting(dasher.settings.Esp_parameters.SP_ALPHABET_ID));
		Screen.setInitialCS(Dasher.getSetting(dasher.settings.Esp_parameters.SP_COLOUR_ID));
	...
	public void changeAlphabet(String alph) {
		...
		Dasher.SetStringParameter(dasher.settings.Esp_parameters.SP_ALPHABET_ID, alph);
	...
	public void changeColours(String col) {
		...
		Dasher.SetStringParameter(dasher.settings.Esp_parameters.SP_COLOUR_ID, col);
