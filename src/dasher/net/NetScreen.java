...
import dasher.core.CCustomColours;
import dasher.core.CDasherView;
import dasher.core.EColorSchemes;
 ...
 * produce them, below.
 */
public class NetScreen implements dasher.core.CDasherScreen {
	 ...
	 */
	protected dasher.core.CCustomColours m_ColourScheme;
	 ...
	 */
	protected Queue<dasher.events.CEditEvent> editEventQueue;
	...
	public NetScreen(int sessID, int width, int height) {
		...
		this.sessID = sessID;
		editEventQueue = new LinkedList<dasher.events.CEditEvent>();
	 ...
	 */
	public void addEditEvent(dasher.events.CEditEvent event) {
	...
	protected void addEditEvents() {
		dasher.events.CEditEvent event;
