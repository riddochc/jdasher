...
public class NetDasherListener {
	...
	public static void ScanFilesByRegex(ArrayList<String> vFileList, String regex) {
		...
		/*try {
			File usrDir = new File(getSetting(dasher.Esp_parameters.SP_USER_LOC));
	...
	public static void main(String[] args) {
		...
		dasher.core.CAlphIO centralAlphIO = new dasher.core.CAlphIO(dataLocation, "", alphFiles, null);
		
		ArrayList<String> colourFiles = new ArrayList<String>();
		ScanFilesByRegex(colourFiles, "colour.*.xml");
		dasher.core.CColourIO centralColourIO = new dasher.core.CColourIO(dataLocation, "", colourFiles, null);
