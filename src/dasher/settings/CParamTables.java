 ...
 * entry added to the appropriate table in this class.</p>
 *
 * @deprecated Use the Ebp_parameters, Elp_parameters, and Esp_parameters enums
 * instead.  They will now hold all this data.
 */
@Deprecated
...
//        new lp_table(Elp_parameters.LP_INPUT_FILTER, "InputFilterID", PERS, 3, "Module ID of input filter"),
    ...
    public sp_table[] StringParamTable = {
        ...
        new sp_table(Esp_parameters.SP_SYSTEM_LOC, "SystemLocation", !PERS, (new File("system.rc")).toString(), "System Directory"),
...
//        new sp_table(Esp_parameters.SP_Filename, "Filename", !PERS, "", "Working file name."),
//        new sp_table(Esp_parameters.SP_FileLocation, "FileLocation", PERS, System.getProperty("user.home"), "The last location the file dialogs accessed")
    };
